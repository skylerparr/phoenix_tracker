import { getAllIcebox } from './issue_service.js';
...
if (import.meta.url === `file://${process.argv[1]}`) {
  const config = parseArgs('IssueService/getAllIcebox.js', {
    includeBaseUrl: true,
    includeOutput: true,
  });
  ...
  getAllIcebox(token, { baseUrl: config.baseUrl, insecure: config.insecure, cacert: config.cacert })
